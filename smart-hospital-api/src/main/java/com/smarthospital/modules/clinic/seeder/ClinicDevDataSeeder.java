...
import com.smarthospital.modules.pharmacy.repository.MedicineCategoryRepository;
import com.smarthospital.modules.pharmacy.repository.MedicineRepository;
...
public class ClinicDevDataSeeder {
    ...
    private void seedUsers() {
        ...
        try {
            ...
            seedUser(DOCTOR_EMAIL,      DOCTOR_PASS,      Role.DOCTOR,            "Dr. Anil", "Sharma");
            seedDoctorEmployee();

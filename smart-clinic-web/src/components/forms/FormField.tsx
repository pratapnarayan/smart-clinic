...
export function FormField<T extends FieldValues>({
  ...
  // Controls the DatePicker popup explicitly so we can force it to close the
  // instant a date is picked. Left uncontrolled, antd sometimes leaves the
  // calendar open after a selection that started from typed input rather
  // than a pure mouse click on the panel, forcing the user to click
  // elsewhere just to dismiss it.

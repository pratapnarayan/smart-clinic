...
export function AppLayout() {
  ...
  // Permission required to see each top-level sidebar entry. Items not
  // listed here (e.g. "dashboard") are visible to every authenticated role.
  // This fixes the sidebar showing every module to every role regardless of
  // what they actually have access to (previously only the OPD-clinic-type
  // whitelist below was applied, not a per-role permission check).
  ...
  const canSeeMenuItem = (key: string): boolean => {

...
--
-- What it does:
--   1. Creates the smartclinic database (if not exists)
...
SELECT 'CREATE DATABASE smartclinic'
WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'smartclinic')\gexec

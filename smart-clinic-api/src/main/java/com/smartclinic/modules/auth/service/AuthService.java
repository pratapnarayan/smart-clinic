...
import com.smartclinic.core.token.RefreshTokenStore;
import com.smartclinic.modules.auth.domain.Permission;
...
import com.smartclinic.modules.auth.dto.UserResponse;
...
public class AuthService {
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        if (org.springframework.util.StringUtils.hasText(request.tenantId())) {
            com.smartclinic.core.tenant.TenantContext.set(request.tenantId());
        }
        ...
        try {
            ...
            com.smartclinic.core.tenant.TenantContext.clear();
        }
        ...
        String accessToken  = jwtTokenProvider.generateAccessToken(
                user.getId().toString(), user.getTenantId(), user.getEmail(),
    ...
    public TokenResponse refresh(String refreshToken) {
        ...
        String newAccess = jwtTokenProvider.generateAccessToken(
                userId, user.getTenantId(), user.getEmail(),
                user.getFirstName(), user.getLastName(), roles, permissions);
    ...
    private List<String> permissionsFor(Role role) {
        return switch (role) {
            ...
            case RECEPTIONIST -> List.of(
                    ...
                    Permission.OPD_VIEW, Permission.OPD_CREATE,
                    Permission.FRONTOFFICE_VIEW, Permission.FRONTOFFICE_CREATE, Permission.FRONTOFFICE_EDIT,
                    Permission.DOCTOR_VIEW,
                    Permission.CLINIC_HOME_COLLECTION_VIEW, Permission.CLINIC_HOME_COLLECTION_CREATE,
                    Permission.CLINIC_HOME_COLLECTION_EDIT,

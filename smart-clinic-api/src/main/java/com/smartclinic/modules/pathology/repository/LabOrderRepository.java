...
public interface LabOrderRepository extends JpaRepository<LabOrder, UUID> {
    ...
    @Query("SELECT COUNT(o) FROM LabOrder o " +
           ...
           "AND o.status <> com.smartclinic.modules.pathology.domain.LabOrder.OrderStatus.CANCELLED")
    ...
    @Query("SELECT COUNT(o) FROM LabOrder o " +
           "WHERE o.status = com.smartclinic.modules.pathology.domain.LabOrder.OrderStatus.PENDING " +
           "   OR o.status = com.smartclinic.modules.pathology.domain.LabOrder.OrderStatus.IN_PROGRESS")
